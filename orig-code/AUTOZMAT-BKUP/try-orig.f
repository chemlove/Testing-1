...
C  Begin parsing through Title and Zmat Coordinates
      ...
      WRITE (ILM,60) TITLE
C  10 I = I + 1
C  11 READ (IZM,70) LINE
C     IF (LINE(1:4).EQ.'    ') GO TO 20
C     READ (LINE,90) LN(I),SOLATS(I),IZTYP(I),IFTYP(I),IZ1(I),ZPAR(I,1),
C    *               IZ2(I),ZPAR(I,2),IZ3(I),ZPAR(I,3),RSNAM(I),IRES(I)
C     GO TO 10
